...
function readFormFields(processDefinitionId) {
    ...
    // 设置表单提交id
    $form.attr('action', WEB_GLOBAL_CTX + '/leave/form/dynamic/start-process/' + processDefinitionId);
    ...
    // 读取启动时的表单
    $.getJSON(WEB_GLOBAL_CTX + '/leave/form/dynamic/get-form/start/' + processDefinitionId, function(data) {
        var trs = "";
