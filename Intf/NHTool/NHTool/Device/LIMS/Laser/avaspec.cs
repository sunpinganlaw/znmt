...
{		  
	...
	public class avaspec
	{
        ...
        public const byte EXT_TRIGGER_SOURCE = 1;
        public const byte SYNCH_TRIGGER_SOURCE = 0;
		...
		const ushort SETTINGS_RESERVED_LEN  = 9720; 
        ...
        [DllImport("avaspecx64.dll")]
        public static extern int AVS_GetOemParameter(IntPtr a_hDevice, ref OemDataType a_pOemData);

        [DllImport("avaspecx64.dll")]
        public static extern int AVS_SetOemParameter(IntPtr a_hDevice, ref OemDataType a_pOemData);
