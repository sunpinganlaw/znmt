...
namespace NHTool.Device.LED
{
    ...
    class LED_Driver
    {
        ...
        public readonly Int32 R_NOT_IN_REPORTLIST = -8;
        ...
        public readonly Int32 NOTIFY_GET_SNAPSHOT = 0x00013001;  //读取控制卡抓屏快照
        ...
        //--------------通过控制卡名称执行命令和发送数据，用于广域网通讯-------------

        //同时用某一端口进行上报包监听和收发数据
        //  localport 监听在线端口
        [DllImport("LEDSender2010.dll")]
        private static extern int LED_Report_CreateServer_Multi(Int32 localport);
        ...
        //--返回值-- 小于0表示失败(未创建该在线监听服务)，大于等于0表示在线的控制卡数量
        [DllImport("LEDSender2010.dll")]
        private static extern String LED_Report_GetOnlineItemNames_Multi(Int32 localport);

        //设置控制卡电源 value=LED_POWER_ON表示开启电源 value=LED_POWER_OFF表示关闭电源
        [DllImport("LEDSender2010.dll")]
        private static extern int LED_SetPower_ByReportName_Multi(ref TSenderParam param, String name, Int32 value);

        //设置控制卡亮度 value取值范围0-7
        [DllImport("LEDSender2010.dll")]
        private static extern int LED_SetBright_ByReportName_Multi(ref TSenderParam param, String name, Int32 value);

        //校正时间，以当前计算机的系统时间校正控制卡的时钟
        [DllImport("LEDSender2010.dll")]
        private static extern int LED_AdjustTime_ByReportName_Multi(ref TSenderParam param, String name);

        //发送节目数据 index为MakeRoot、MakeChapter、MakeRegion、MakeLeaf、MakeObject函数的返回值
        [DllImport("LEDSender2010.dll")]
        private static extern int LED_SendToScreen_ByReportName_Multi(ref TSenderParam param, String name, Int32 index);
        ...
        //压缩数据
        [DllImport("LEDSender2010.dll")]
        private static extern int LED_Compress(Int32 index);
        ...
        //读取控制卡抓屏快照内容
        [DllImport("LEDSender2010.dll")]
        private static extern int LED_GetSnapShot(ref TSenderParam param);

        //procedure BufferFileToBitmapFile(ABufferFile: PChar; AFileName: PChar); stdcall;
        //读取控制卡抓屏快照内容
        [DllImport("LEDSender2010.dll")]
        private static extern void BufferFileToBitmapFile(String buffer_file, String bmp_file);
        ...
        public int Do_LED_GetSnapShot(ref TSenderParam param)
        {
            return LED_GetSnapShot(ref param);
        }

        public void Do_BufferFileToBitmapFile(String buffer_file, String bmp_file)
        {
            BufferFileToBitmapFile(buffer_file, bmp_file);
        }
        ...
        public int Do_LED_Report_CreateServer_Multi(Int32 localport)
        {
            return LED_Report_CreateServer_Multi(localport);
        }

        public String Do_LED_Report_GetOnlineItemNames_Multi(Int32 localport)
        {
            return LED_Report_GetOnlineItemNames_Multi(localport);
        }

        public int Do_LED_SetPower_ByReportName_Multi(ref TSenderParam param, String name, Int32 value)
        {
            return LED_SetPower_ByReportName_Multi(ref param, name, value);
        }

        public int Do_LED_SetBright_ByReportName_Multi(ref TSenderParam param, String name, Int32 value)
        {
            return LED_SetBright_ByReportName_Multi(ref param, name, value);
        }

        public int Do_LED_AdjustTime_ByReportName_Multi(ref TSenderParam param, String name)
        {
            return LED_AdjustTime_ByReportName_Multi(ref param, name);
        }

        public int Do_LED_SendToScreen_ByReportName_Multi(ref TSenderParam param, String name, Int32 index)
        {
            return LED_SendToScreen_ByReportName_Multi(ref param, name, index);
        }
