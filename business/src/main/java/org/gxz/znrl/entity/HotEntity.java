...
public class HotEntity {
    ...
    public String getHotResId() {
        return hotResId;
    }

    public void setHotResId(String hotResId) {
        this.hotResId = hotResId;
    }
    ...
    public String getTempIncrease() {
        return tempIncrease;
    }

    public void setTempIncrease(String tempIncrease) {
    ...
    public String getJqTemp() {
        return jqTemp;
    }

    public void setJqTemp(String jqTemp) {
        this.jqTemp = jqTemp;
    }
