package org.gxz.znrl.util.qrcode;
...
public class ZXingCode
{
    public static void main(String[] args) throws WriterException
    {
        ...
        try
        {
            ...
            BufferedImage bim = zp.getQR_CODEBufferedImage(content, BarcodeFormat.QR_CODE, 80, 80, zp.getDecodeHintType());
...
//            zp.parseQR_CODEImage(new File("D:/二维码生成/TDC-test.png"));
    ...
    public boolean createZXingCode(String filePath,String content ){
        try
        {
            File file = new File(filePath);
